	...
	<div class="album py-5 bg-light">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="card mb-4 box-shadow gallery">
						<img class="card-img-top" src="images/bikers/DobroslawaDaytona-Bike5.jpg" alt="Card image cap">
						<div class="card-body">
							<p class="card-text">Dobroslawa.</p>
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="card mb-4 box-shadow gallery">
						<img class="card-img-top" src="images/bikers/Zalewski-BikeDaytona2.jpg" alt="Card image cap">
						<div class="card-body">
							<p class="card-text">Daytona.</p>
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="card mb-4 box-shadow gallery">
						<img class="card-img-top" src="images/bikers/ZalewskiHarley-Milwaukee.JPG" alt="Card image cap">
						<div class="card-body">
							<p class="card-text">Milwaukee.</p>
						</div>
					</div>																					
				</div>
			</div>
